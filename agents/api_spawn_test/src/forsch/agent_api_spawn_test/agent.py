"""api_spawn_test_agent agent definition (generated by the Forsch ADK Factory — do not hand-edit; edit agent_specs/agents.yaml)."""
...
_LITELLM_API_KEY = (
    os.environ.get("ADK_LITELLM_KEY_API_SPAWN_TEST")  # per-agent key → per-agent LiteLLM analytics
...
root_agent = Agent(
    name='api_spawn_test_agent',
    model=api_spawn_test_model,
    description='api_spawn_test agent',
    instruction='api proxy test',
    tools=[
        get_crm_health_snapshot,
    ],
)
