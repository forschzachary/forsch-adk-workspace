"""proxy_spawn_test_agent agent definition (generated by the Forsch ADK Factory — do not hand-edit; edit agent_specs/agents.yaml)."""
...
_LITELLM_API_KEY = (
    os.environ.get("ADK_LITELLM_KEY_PROXY_SPAWN_TEST")  # per-agent key → per-agent LiteLLM analytics
...
proxy_spawn_test_model = LiteLlm(
...
root_agent = Agent(
    name='proxy_spawn_test_agent',
    model=proxy_spawn_test_model,
    description='proxy_spawn_test agent',
    instruction='test proxy auto-spawn',
    tools=[
        get_crm_health_snapshot,
        list_recent_crm_leads,
    ],
