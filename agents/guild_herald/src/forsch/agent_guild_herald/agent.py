"""guild_herald_agent agent definition (generated by the Forsch ADK Factory — do not hand-edit; edit agent_specs/agents.yaml)."""
...
_LITELLM_API_KEY = (
    os.environ.get("ADK_LITELLM_KEY_GUILD_HERALD")  # per-agent key → per-agent LiteLLM analytics
...
root_agent = Agent(
    name='guild_herald_agent',
    model=guild_herald_model,
    description='guild_herald agent',
    instruction='test',
    tools=[
        get_crm_health_snapshot,
        list_recent_crm_leads,
