"""test_autospawn_agent agent definition (generated by the Forsch ADK Factory — do not hand-edit; edit agent_specs/agents.yaml)."""
...
_LITELLM_API_KEY = (
    os.environ.get("ADK_LITELLM_KEY_TEST_AUTOSPAWN")  # per-agent key → per-agent LiteLLM analytics
...
root_agent = Agent(
    name='test_autospawn_agent',
    model=test_autospawn_model,
    description='test_autospawn agent',
    instruction='test',
    tools=[
        get_crm_health_snapshot,
    ],
