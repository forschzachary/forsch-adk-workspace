# CLAUDE.md — Forsch ADK Agent Factory (read this first)
...
- **You (Hubert / the orchestrator)** read your standing instructions from **this file** (`CLAUDE.md`, walked up from cwd by mimocode) plus the box-level `/root/.hermes/workspace/AGENTS.md` (Hermes/LiteLLM/Authsome context — *outside* this repo, not gate-controlled).
