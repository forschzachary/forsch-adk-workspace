---
goal: "Build the ops agent cluster — infrastructure monitoring, CRM health, deployment state"
status: building
handoff_pct: 65
data_connectors:
  - frappe-crm
...
## What's working
- ops agent: L3 round-trip proven, CRM tools functional, role=builder
...
- Wire CRM Gameplan project management into ops tools
